...
const RatingSelect = ({ select }) => {
  ...
  return (
    <ul className='rating'>
        ...
        <li>
            <input type='radio' id='nu4' name='rating' value='4' onChange={handleChange} checked={selected === 4} />
        ...
        <li>
            <input type='radio' id='num' name='rating' value='10' onChange={handleChange} checked={selected === 10} />
